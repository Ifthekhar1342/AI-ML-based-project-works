...
class featuresDetection:
    ...
    def laser_points_set(self, data):
        ...
        def seed_segments_growing(self, indices, break_point):
            line_eq = self.LINE_PARAMS
            i, j = indices

            #Begining and final point of the line segment
            ...
            while self.dist_point2line(line_eq, self.LASERPOINTS[PF][0]) < self.EPSILON:
                ...
                if self.dist_point2line(POINT, NEXTPOINT) > self.GMAX:
                    break
            ...
            while self.dist_point2line(line_eq, self.LASERPOINTS[PB][0]):
                if PB < break_point:
                    ...
                    m, b = self.odr_fit(self.LASERPOINTS)
                    line_eq = self.lineForm_Si2G(m, b)
